...
\begin{center}
    ...
    \sanhao\textbf{实验桌号：\underline{\makebox[8cm]{ 04 }}} \\[10pt]
    \sanhao\textbf{指导教师：\underline{\makebox[8cm]{ 沈昊 }}} \\[20pt]
...
\section{预习报告}
    ...
    \centering
    \includegraphics[width=7cm]{电桥.png}
    \caption{惠斯通电桥电路图}
    \label{fig:图1}
    \end{wrapfigure}
...
\section{原始数据}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=11cm]{实验数据.jpg}
        \caption{实验数据}
        \label{fig:图2}
    \end{figure}
