...
\begin{center}
    ...
    \sanhao\textbf{实验桌号：\underline{\makebox[8cm]{ 14 }}} \\[10pt]
    \sanhao\textbf{指导教师：\underline{\makebox[8cm]{ 谢东洋 }}} \\[20pt]
...
\section{预习报告}
    ...
    \centering
    \includegraphics[width=8cm]{棱镜偏向角.png}
    \caption{最小偏向角原理}
    \label{fig:principle}
    \end{wrapfigure}
...
\section{原始数据}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=16cm]{实验数据.jpg}
        \caption{实验数据}
        \label{fig:图2}
    \end{figure}
...
\section{结果与分析}
    ...
    \
        ...
        \begin{figure}[H]
        \centering
        \includegraphics[width=15cm]{nonlinear_fit_chart.jpg}
