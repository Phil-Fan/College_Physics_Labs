...
\section{预习报告}
    ...
    \centering
    \includegraphics[width=7cm]{figures/示波器.png}
    \caption{示波器原理图}
    \label{fig:图1}
    \end{wrapfigure}
    ...
    \begin{wrapfigure}{r}{0.4\textwidth}
    \centering
    \includegraphics[width=7cm]{figures/波形扫描原理.png}
    \caption{波形扫描原理}
    \label{fig:图2}
    \end{wrapfigure}
...
\section{原始数据}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=18cm]{figures/实验数据.jpg}
        \caption{实验数据}
        \label{fig:图3}
    \end{figure}
...
\section{结果与分析}
    ...
    \begin{table}[htbp]
        ...
        \begin{tabular}{*{7}{c}} % 定义表格有7列，每一列都居中(c)
            ...
            \midrule % 画出中间的分割线 (来自 booktabs)
            图形 & \includegraphics[width=60pt]{figures/1：1.jpg}  &
            \includegraphics[width=60pt]{figures/1：2.jpg}   &
            \includegraphics[width=60pt]{figures/1：3.jpg}   &
            \includegraphics[width=60pt]{figures/2：1.jpg}   &
            \includegraphics[width=60pt]{figures/2：3.jpg}   &
            \includegraphics[width=60pt]{figures/3：1.jpg}  \\
            $ N_y $ & 2 & 4 & 6 & 2 & 6 & 2 \\
            $ N_x $ & 2 & 2 & 2 & 4 & 4 & 6 \\
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=.35\textwidth]{figures/二极管测量.jpg}
        \caption{测量时示波器显示图形}
        \label{fig:图4}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=.35\textwidth]{figures/相位差测量.jpg}
        \caption{测量时示波器显示图形}
        \label{fig:图4}
    \end{figure}
